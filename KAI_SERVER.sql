...
CREATE TABLE ALBUM(
    ...
    ALBUM_OWNER VARCHAR2(100) NOT NULL,
...
CREATE TABLE LICENSED_ARTIST(
    LCN_ARTIST_NAME VARCHAR2(100) PRIMARY KEY,
...
CREATE TABLE SONG (
    ...
    SONG_ARTIST VARCHAR2(100) NOT NULL,
...
CREATE TABLE PLAYLIST(
    ...
    LISTED_SONG_NO NUMBER REFERENCES SONG(SONG_NO) ON     
);
...
CREATE TABLE LIKELIST(
    USER_ID VARCHAR2(20) REFERENCES WEB_USER(USER_ID) ON DELETE CASCADE,
    LIKED_SONG_NO NUMBER REFERENCES SONG(SONG_NO)    
);
...
CREATE TABLE INQUIRY(
    ...
    INQ_CONTENT VARCHAR2(6000) NOT NULL,
...
CREATE TABLE INQ_ANS (
    ...
    INQ_ANS_CONTENT VARCHAR2(6000) NOT NULL,
...
CREATE TABLE NOTICE(
    ...
    NOTICE_CONTENT VARCHAR2(6000) NOT NULL,
