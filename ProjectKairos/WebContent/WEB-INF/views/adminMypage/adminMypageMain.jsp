...
<link href="/src/css/adminMypage/adminmypagemain.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<section> <c:if test="${sessionScope.user.userId == 'admin' }">
		<h2 class="h2">
			내 정보 <span class="span1">로그인계정 : </span> <span class="span1">${sessionScope.user.userId }</span>
		</h2>
		<div class="PHJup">
			<h3>관리자 정보수정</h3>
			<div class="div1">
