...
<body>
	...
	<section>
		<h2>1:1문의하기</h2>
		<form action="/insertInquiry" method="post" enctype="multipart/form-data" id="frm">
         <table>
	          <tr>
	             <th style="width:100px;">제목</th>
	             <td style="width:700px;"><input type="text" class="form-control" name="inquiryTitle" style="width:580px;"></td>
	          </tr>
	          <tr>
		          <th>작성자</th>
	          ...
	          <tr style="border-bottom:1px solid black;">
	          	<th>내용</th>
	          	<td>
	          		<textarea name="inquiryContent" id="ir1" style="width:610px; height:600px;"></textarea>
	          	</td>
	          </tr>
