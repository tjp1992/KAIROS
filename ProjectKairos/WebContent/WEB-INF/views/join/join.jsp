...
<html>
  <head>
    ...
    <script src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=rqfxm5odrc&submodules=geocoder"></script>
    ...
    $(function () {
      ...
      $("#mailBtn").click(function () {
        if ($("#mail1").val() == "") {
          ...
          $("#join").append(
            "<input type='hidden' name = 'fullMail' value='" + email + "'>"
          );
          $.ajax({
            url: "/sendMail",
            type: "post",
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                />
                <button type="button" id="mailResult" style="display: none;">
                  메일확인
                </button>
            ...
            <tr>
              ...
              <td id="addr">
                ...
                <input
                  ...
                  name="detailAddr"
                  class="border border-warning"
                  style="width: 400px; height: 35px; font-size: 10pt;"
                  type="text"
                  placeholder="상세주소"
                  required
                />
