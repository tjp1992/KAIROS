    ...
    <section>
      <div class="psearchoutline">
        <div class="psearch_wrapper">
          <div class="psearchname">
            <a id="plist">플레이리스트</a> 내 검색결과
          </div>
          <div class="plsearch">
          ...
          <table>
            <c:forEach items="${list }" var="p">
              ...
              >
                ...
                <th width="10%" class="playimg">
                  <i class="iconplay far fa-play-circle"></i>
                </th>
                <th width="10%" class="deleteimg">
                  <i class="icondelete far fa-trash-alt"></i>
                </th>
              </tr>
            </c:forEach>
          </table>
        ...
        $(".heartimg")
          ...
          .click(function () {
            if ($(this).attr("class") == "iconheart far fa-heart") {
              $(this).attr(
                "class",
                "iconheart fas fa-hearticonheart fas fa-heart"
              );
              $(this).css("color", "red");
            } else {
