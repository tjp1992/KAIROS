	...
	<section class="container">
		<div class="py-5 text-center">
			<img class="d-block mx-auto mb-4"
				src="/src/imgs/logo/main_logo(no).png" alt width="250" height="130">
			<h2 class="m-4">이용권 구매</h2>
			<p class="lead m-2">회원권을 구매 함으로써 고객님은 무한의 음악을 즐기기 위해 첫 걸음을 밟으십니다.
			</p>
			<p class="lead m-2">고객님께서 저희 서비스를 이용 함 으로써 개인 아티스트를 지원하게 되며 보다 나은
				음악을 제공하게 됩니다.</p>
		</div>
		<div class="row">
			<div class="col-md-4 order-md-2 mb-4">
				...
				<ul class="list-group mb-3">
					<li
						...
						</div> <span class="text-muted">9,900원</span>
					</li>
					<li class="list-group-item d-flex justify-content-between"><span>Total
							(KRW)</span> <strong class="price">9,900원</strong></li>
				</ul>
				<form class="card p-2">
			...
			<div class="col-md-8 order-md-1">
				<form class="needs-validation" action="/paymentComplete"
					...
					<div class="mb-3">
						<label for="addr">주소<span>(필수 확인)</span></label> <input
