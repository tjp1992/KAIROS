    ...
    <section class="container">
      <div class="jumbotron p-0 m-2">
        <div class="view overlay rounded-top">
          <img
            src="/src/imgs/TJImg/voucherImg2.jpg"
            class="img-fluid"
            alt="Sample image"
          />
          <a href="#">
        ...
        <div class="card-body text-center mb-3">
          ...
          <!-- Text -->
          <p class="lead">
            이용권 구매를 하셔서 다양한 혜택을 같이 이용 가능합니다
          </p>
          <!-- Button -->
        ...
        <div class="row marketing">
          <div class="col-lg-4">
            <div class="card m-2" style="width: 20rem;">
              <img
                src="/src/imgs/TJImg/licensedMusic.jpg"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  라이센스 음반을 무제한 감상 무료 음반을 넘어선 최신 음악을
                  감상할 수 있는 추가 기능이 부여 됩니다.
                </p>
              </div>
            </div>
            <div class="card m-2" style="width: 20rem;">
              <img
                src="/src/imgs/TJImg/event.jpg"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  웹사이트에서 수익의 몇프로를 개인 아티스트의 지원금으로
                  투자되며 개인 아티스트들이 새로운 음원을 만들기 위한 도움에
                  사용됩니다.
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="card m-2" style="width: 20rem;">
              <img
                src="/src/imgs/TJImg/download.png"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  본인이 원하는 개인 아티스트의 무료 음원을 무제한 다운로드.
                  소장하고 싶은 음원을 오프라인으로 어디서나 감상 가능!
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card m-2" style="width: 20rem;">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  이용권 구매시 무제한 고속 스트리밍 이용 가능. 음원을 어디서나
                  제일 빠른 속도로 감상!
                </p>
              </div>
            </div>
